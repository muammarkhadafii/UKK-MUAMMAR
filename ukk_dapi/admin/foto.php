...
?>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
				<div class="card mt-2 bg-danger">
					<div class="card-header bg-dark text-light"> Tambah Foto </div>
						<div class="card-body">
						<form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
						<label class="form-label text-light"> Judul Foto </label>
						<input type="text" name="judulfoto" class="form-control" required>
						<label class="form-label text-light"> Deskripsi Foto </label>
		...
		<div class="col-md-8">
			<div class="card mt-2 bg-danger">
				<div class="card-header bg-dark text-light"> Data Galeri Foto </div>
					<div class="card-body">
						<table class="table">
							<thead>
								<tr>
